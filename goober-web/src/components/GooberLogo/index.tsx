export function GooberLogo() {
  return (
    <strong className="mx-1 mb-4 flex items-center gap-1 text-xl font-semibold text-indigo-900">
      <svg
      ...
      <span className="text-indigo-900">oober</span>
    </strong>
  )
}
